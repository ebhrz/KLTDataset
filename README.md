...
with open("label/1106_KLT1_203/nlos.pkl",'wb') as f: # KLT1_203 for example
...
for label in labels:
   ...
   for satid in label[4]:
      part = label[4][satid]
      print(f"satellite {satid}: the part image shape of the satellite projection on the flatten fisheye image: ", part[0])
...
[^8]: R. Hu, W. Wen, and L.-T. Hsu, “Fisheye camera aided GNSS NLOS detection and learning-based pseudorange bias correction for intelligent vehicles in urban canyons,” in *2023 IEEE 26th International Conference on Intelligent Transportation Systems (ITSC)*, IEEE, 2023, pp. 6088–6095.
